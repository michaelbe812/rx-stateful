...
@Component({
  selector: 'demo-all-in-one-tabbed',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    AsyncPipe,
  ...
  template: `
    <h1>All-in-One rxRequest Demo - Tabbed Layout</h1>
    <p>Configure all rxRequest behaviors using organized tabs. Same features as the original demo with a different layout.</p>
      ...
      <mat-card class="config-panel">
        ...
        <mat-card-content>
          <mat-tab-group>
            ...
            <!-- Refetch Strategies Tab -->
            <mat-tab label="Refetch Strategies">
              <div class="tab-content">
                <form [formGroup]="configForm">
                  <div class="form-section">
...
export class DemoAllInOneTabbedComponent {
